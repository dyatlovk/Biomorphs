...
" General colors
hi Cursor         guifg=#000000 guibg=#000000 ctermfg=0 ctermbg=5
hi NonText        guifg=#5f5fff ctermfg=63
hi Normal         guifg=#bcbcbc guibg=#121212 ctermfg=250 ctermbg=0
...
hi Visual         guifg=#afffff guibg=#000000 gui=bold ctermfg=159 ctermbg=255 cterm=bold
