...
beautiful.init(awful.util.getdir("config") .. "/themes/biomorphs/theme.lua")
...
tags = {
  names  = { "Terminal", "Web", "Dev", "IM", "Media", "Secure"},
...
myawesomemenu = {
   ...
   { "edit theme", editor_cmd .. " " .. awful.util.getdir("config") .. "/themes/biomorphs/theme.lua", freedesktop.utils.lookup_icon({ icon = 'package_settings' }) },
...
vicious.register(cpu, vicious.widgets.cpu, '<span color="' .. yellow .. '">CPU:</span> $1%', 2)

mem = wibox.widget.textbox()
vicious.register(mem, vicious.widgets.mem, '<span color="' .. red .. '">RAM:</span> $1% ($2MB)', 5)
...
--    awful.key({ modkey }, "p", function() menubar.show() end) -- Default M-p command, dmenu is a better/faster alternative
    awful.key({ modkey }, "p", function () awful.util.spawn_with_shell("dmenu_run -h '18' -i -nb '" .. beautiful.bg_normal .. "' -nf '" .. beautiful.fg_normal .. "' -sb '" .. beautiful.bg_focus .. "' -sf '" .. beautiful.fg_focus .. "' -fn 'Dejavu:size=10'") end),
...
awful.rules.rules = {
	...
	{ rule = { class = "jetbrains-phpstorm"}, properties = {tag = tags[1][3]} },
	{ rule = { class = "KeePass2"} ,properties = {tag = tags[1][6], floating = true} },
	{ rule = {class = "Conky"}, properties = {border_width = 0, floating = true} },
	{ rule = {class = "Pale moon"}, properties = {tag = tags[1][2]} },
